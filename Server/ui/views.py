...
def events(request, pk):
    ...
    for event in events:
        ...
        processes_string = get_processes_to_string(processes)
...
def get_processes_to_string(processes):
    processes_custom = []
    for obj in processes:
        list_processes = ""
        for p in obj['list']:
            list_processes += """<span class='process'>{} </span>""".format(p)
    ...
    return processes_custom

raimbow_colors = [
    '#ff0000','#ffa500','#ffff00','#008000','#0000ff','#800080','#808080','#a52a2a','#ffc0cb','#00ffff','#ff00ff','#dc143c','#4b0082','#00ff00','#808000','#008080','#000080','#800000','#c0c0c0','#00ffff','#32cd32','#ffd700','#fa8072'
]